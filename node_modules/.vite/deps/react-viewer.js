...
//#region node_modules/react-viewer/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(A, e) {
		"object" == typeof exports && "object" == typeof module ? module.exports = e(require_react(), require_react_dom()) : "function" == typeof define && define.amd ? define(["react", "react-dom"], e) : "object" == typeof exports ? exports["react-viewer"] = e(require_react(), require_react_dom()) : A["react-viewer"] = e(A.React, A.ReactDOM);
	})(exports, (function(A, e) {
		return function(A) {
			var e = {};
			function t(n) {
			...
			return t.m = A, t.c = e, t.d = function(A, e, n) {
				...
				if (t.r(n), Object.defineProperty(n, "default", {
					enumerable: !0,
					value: A
				}), 2 & e && "string" != typeof A) for (var i in A) t.d(n, i, function(e) {
					return A[e];
				}.bind(null, i));
				return n;
			}, t.n = function(A) {
			...
			function(A, e, t) {
				e = A.exports = t(7)(!1);
				var n = t(8), i = n(t(2)), o = n(t(2) + "?#iefix"), r = n(t(9)), a = n(t(10)), c = n(t(11));
				e.push([
					A.i,
				...
				A.exports = function(A) {
					...
					return e.toString = function() {
						return this.map((function(e) {
							var t = function(A, e) {
								...
								if (e && "function" == typeof btoa) {
									var i = (r = n, a = btoa(unescape(encodeURIComponent(JSON.stringify(r)))), c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "/*# ".concat(c, " */")), o = n.sources.map((function(A) {
						...
						for (var r = 0; r < A.length; r++) {
							var a = A[r];
							null != a[0] && n[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = "(".concat(a[2], ") and (").concat(t, ")")), e.push(a));
						}
					}, e;
				};
			},
			...
			function(A, e, t) {
				...
				function a(A, e) {
					for (var t = [], n = {}, i = 0; i < A.length; i++) {
						var o = A[i], r = e.base ? o[0] + e.base : o[0], a = {
							css: o[1],
							media: o[2],
							sourceMap: o[3]
						};
				...
				function l(A) {
					...
					if (Object.keys(A.attributes).forEach((function(t) {
				...
				function s(A, e, t, n) {
					...
					if (A.styleSheet) A.styleSheet.cssText = u(e, i);
						...
						r[e] && A.removeChild(r[e]), r.length ? A.insertBefore(o, r[e]) : A.appendChild(o);
					}
				}
				function M(A, e, t) {
					var n = t.css, i = t.media, o = t.sourceMap;
					if (i && A.setAttribute("media", i), o && btoa && (n += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(o)))), " */")), A.styleSheet) A.styleSheet.cssText = n;
					else {
				...
				function E(A, e) {
					...
					if (e.singleton) {
						var o = w++;
						t = d || (d = l(e)), n = s.bind(null, t, o, !1), i = s.bind(null, t, o, !0);
					} else t = l(e), n = M.bind(null, t, e), i = function() {
						(function(A) {
			...
			function(A, e, t) {
				...
				function l(A, e) {
					return function(A) {
						...
						try {
							for (var r, a = A[Symbol.iterator](); !(n = (r = a.next()).done) && (t.push(r.value), !e || t.length !== e); n = !0);
						} catch (A) {
							i = !0, o = A;
						} finally {
							try {
				...
				function g(A) {
					...
					function u(n) {
						0 === n.button && A.visible && A.drag && (n.preventDefault(), n.stopPropagation(), e.current = !0, t.current = {
					...
					n.useEffect((function() {
						...
						return A.visible && A.drag && w(), !A.visible && A.drag && M({}), function() {
							w(!0);
						};
					}), [A.drag, A.visible]), n.useEffect((function() {
						var e = r.x - t.current.x, n = r.y - t.current.y;
						t.current = {
							x: r.x,
							y: r.y
					...
					function d(e) {
						var t = A.container && A.container.ownerDocument.defaultView ? A.container.ownerDocument.defaultView : window;
						e ? t.removeEventListener("resize", g, !1) : t.addEventListener("resize", g, !1);
					}
					function w(e) {
						var t = A.container ? A.container.ownerDocument : document;
						e ? (t.removeEventListener("click", M, !1), t.removeEventListener("mousemove", s, !1)) : (t.addEventListener("click", M, !1), t.addEventListener("mousemove", s, !1));
					}
					var E, f, B, I = {
						width: "".concat(A.width, "px"),
						height: "".concat(A.height, "px"),
						transform: "\ntranslateX(".concat(null !== A.left ? A.left + "px" : "aoto", ") translateY(").concat(A.top, "px)\n    rotate(").concat(A.rotate, "deg) scaleX(").concat(A.scaleX, ") scaleY(").concat(A.scaleY, ")")
					}, D = c()("".concat(A.prefixCls, "-image"), (E = { drag: A.drag }, f = "".concat(A.prefixCls, "-image-transition"), B = !e.current, f in E ? Object.defineProperty(E, f, {
						value: B,
						enumerable: !0,
						configurable: !0,
						writable: !0
					}) : E[f] = B, E)), v = { zIndex: A.zIndex }, y = null;
					return "" !== A.imgSrc && (y = n.createElement("img", {
						className: D,
						src: A.imgSrc,
						style: I,
						onMouseDown: u
					})), A.loading && (y = n.createElement("div", { style: {
						display: "flex",
						height: A.container ? "100%" : "".concat(window.innerHeight - 84, "px"),
				...
				function u(A) {
					var e = A.activeIndex, t = void 0 === e ? 0 : e;
					var i = { marginLeft: "calc(50% - ".concat(t + 1, " * 31px)") };
					return n.createElement("div", { className: "".concat(A.prefixCls, "-navbar") }, n.createElement("ul", {
						className: "".concat(A.prefixCls, "-list ").concat(A.prefixCls, "-list-transition"),
						style: i
				...
				function s(A) {
					return n.createElement("i", { className: "".concat("react-viewer-icon", " ").concat("react-viewer-icon", "-").concat(r[A.type]) });
				}
				(function(A) {
					A[A.zoomIn = 1] = "zoomIn", A[A.zoomOut = 2] = "zoomOut", A[A.prev = 3] = "prev", A[A.next = 4] = "next", A[A.rotateLeft = 5] = "rotateLeft", A[A.rotateRight = 6] = "rotateRight", A[A.reset = 7] = "reset", A[A.close = 8] = "close", A[A.scaleX = 9] = "scaleX", A[A.scaleY = 10] = "scaleY", A[A.download = 11] = "download";
				})(r || (r = {}));
				var M = [
					{
						key: "zoomIn",
					...
					{
						key: "rotateLeft",
						actionType: r.rotateLeft
					},
					{
						key: "rotateRight",
						actionType: r.rotateRight
					},
					{
						key: "scaleX",
						actionType: r.scaleX
				...
				function w(A) {
					function e(e) {
						var t = null;
						return void 0 !== r[e.actionType] && (t = n.createElement(s, { type: e.actionType })), e.render && (t = e.render), n.createElement("li", {
							key: e.key,
					...
					var t = A.attribute ? n.createElement("p", { className: "".concat(A.prefixCls, "-attribute") }, A.alt && "".concat(A.alt), A.noImgDetails || n.createElement("span", { className: "".concat(A.prefixCls, "-img-details") }, "(".concat(A.width, " x ").concat(A.height, ")")), A.showTotal && n.createElement("span", { className: "".concat(A.prefixCls, "-showTotal") }, "".concat(A.activeIndex + 1, " ").concat(A.totalName, " ").concat(A.count))) : null, i = A.toolbars;
					return A.zoomable || (i = d(i, ["zoomIn", "zoomOut"])), A.changeable || (i = d(i, ["prev", "next"])), A.rotatable || (i = d(i, ["rotateLeft", "rotateRight"])), A.scalable || (i = d(i, ["scaleX", "scaleY"])), A.downloadable || (i = d(i, ["download"])), n.createElement("div", null, t, n.createElement("ul", { className: "".concat(A.prefixCls, "-toolbar") }, i.map((function(A) {
						return e(A);
					}))));
				}
				function E(A, e, t) {
				...
				function I() {}
				var D = "setVisible", v = "setActiveIndex", y = "update", h = "clear";
				function b(A, e) {
					return {
						type: A,
						payload: e || {}
				...
				var N = function(A) {
					var e, t = A.visible, i = void 0 !== t && t, o = A.onClose, a = void 0 === o ? I : o, l = A.images, d = void 0 === l ? [] : l, N = A.activeIndex, Q = void 0 === N ? 0 : N, T = A.zIndex, m = void 0 === T ? 1e3 : T, p = A.drag, x = void 0 === p || p, C = A.attribute, j = void 0 === C || C, z = A.zoomable, Y = void 0 === z || z, L = A.rotatable, k = void 0 === L || L, G = A.scalable, O = void 0 === G || G, R = A.onMaskClick, U = void 0 === R ? I : R, S = A.changeable, P = void 0 === S || S, H = A.customToolbar, J = void 0 === H ? function(A) {
						return A;
					} : H, F = A.zoomSpeed, W = void 0 === F ? .05 : F, Z = A.disableKeyboardSupport, X = void 0 !== Z && Z, V = A.noResetZoomAfterChange, K = void 0 !== V && V, q = A.noLimitInitializationSize, _ = void 0 !== q && q, $ = A.defaultScale, AA = void 0 === $ ? 1 : $, eA = A.loop, tA = void 0 === eA || eA, nA = A.disableMouseZoom, iA = void 0 !== nA && nA, oA = A.downloadable, rA = void 0 !== oA && oA, aA = A.noImgDetails, cA = void 0 !== aA && aA, lA = A.noToolbar, gA = void 0 !== lA && lA, uA = A.showTotal, sA = void 0 === uA || uA, MA = A.totalName, dA = void 0 === MA ? "of" : MA, wA = A.minScale, EA = void 0 === wA ? .1 : wA, fA = {
						visible: !1,
						visibleStart: !1,
						transitionEnd: !1,
					...
					function BA() {
						...
						return A.container && (e = A.container.offsetWidth, t = A.container.offsetHeight), {
							width: e,
							height: t
						};
					}
					var IA = n.useRef(BA()), DA = A.noFooter ? 0 : 84;
					var vA = n.useRef(null), yA = n.useRef(!1), hA = n.useRef(0), bA = f(n.useReducer((function(A, e) {
						switch (e.type) {
							case D: return B(B({}, A), { visible: e.payload.visible });
							case v: return B(B({}, A), {
								activeIndex: e.payload.index,
								startLoading: !0
							});
							case y: return B(B({}, A), e.payload);
							case h: return B(B({}, A), {
								width: 0,
								height: 0,
								scaleX: AA,
					...
					function TA(e) {
						...
						function r(i, o, r) {
							if (e === hA.current) {
								var a = i, c = o;
								A.defaultSize && (a = A.defaultSize.width, c = A.defaultSize.height), n.defaultSize && (a = n.defaultSize.width, c = n.defaultSize.height);
								var l = f(mA(a, c), 2), g = l[0], u = l[1], s = (IA.current.width - g) / 2, M = (IA.current.height - u - DA) / 2, d = AA, w = AA;
								K && !t && (d = NA.scaleX, w = NA.scaleY), QA(b(y, {
									width: g,
									height: u,
									left: s,
									top: M,
						...
						o.onload = function() {
							yA.current && (i || r(o.width, o.height, !0));
						}, o.onerror = function() {
							yA.current && (A.defaultImg ? (QA(b(y, {
								loading: !1,
								loadFailed: !0,
								startLoading: !1
							})), r(A.defaultImg.width || .5 * IA.current.width, A.defaultImg.height || .5 * IA.current.height, !1)) : QA(b(y, {
								loading: !1,
								loadFailed: !1,
								startLoading: !1
							})));
						}, o.src = n.src, o.complete && (i = !0, r(o.width, o.height, !0));
					}
					function mA(A, e) {
						var t = 0, n = 0, i = .8 * IA.current.width, o = .8 * (IA.current.height - DA);
						return (n = (t = Math.min(i, A)) / A * e) > o && (t = (n = o) / e * A), _ && (t = A, n = e), [t, n];
					}
					function pA(e) {
						if ((tA || !(e >= d.length || e < 0)) && (e >= d.length && (e = 0), e < 0 && (e = d.length - 1), e !== NA.activeIndex)) {
							if (A.onChange) {
								var t = xA(e);
								A.onChange(t, e);
							}
					...
					function xA() {
						var A = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0, e = {
							src: "",
							alt: "",
							downloadUrl: ""
						}, t = null;
						return t = void 0 !== A ? A : NA.activeIndex, d.length > 0 && t >= 0 && (e = d[t]), e;
					}
					function CA() {
						var A = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
						QA(b(y, { rotate: NA.rotate + 90 * (A ? 1 : -1) }));
					}
					function jA(e) {
						switch (e) {
							case r.prev:
							...
							case r.reset:
								...
								break;
							case r.scaleX:
								o = -1, QA(b(y, { scaleX: NA.scaleX * o }));
								break;
							case r.scaleY:
								(function(A) {
									QA(b(y, { scaleY: NA.scaleY * A }));
								})(-1);
								break;
							case r.download: (i = xA()).downloadUrl && (A.downloadInNewWindow ? window.open(i.downloadUrl, "_blank") : location.href = i.downloadUrl);
						}
						var i, o;
					}
					function zA() {
						...
						var n = A.container ? A.container.ownerDocument : document;
						X || n[t]("keydown", YA, !0), vA.current && vA.current[t]("wheel", LA, !1);
					}
					function YA(A) {
						var e = !1;
						switch (A.keyCode || A.which || A.charCode) {
							case 27:
								...
								break;
							case 37:
								A.ctrlKey ? jA(r.rotateLeft) : jA(r.prev), e = !0;
								break;
							case 39:
								A.ctrlKey ? jA(r.rotateRight) : jA(r.next), e = !0;
								break;
							case 38:
								jA(r.zoomIn), e = !0;
								break;
							case 40:
								jA(r.zoomOut), e = !0;
								break;
							case 49: A.ctrlKey && (TA(NA.activeIndex), e = !0);
						}
					...
					function kA() {
						return {
							x: NA.left + NA.width / 2,
							y: NA.top + NA.height / 2
						};
					}
					function GA(e, t, n, i) {
						var o = kA(), r = e - o.x, a = t - o.y, c = 0, l = 0, g = 0, u = 0, s = 0, M = 0;
						if (0 === NA.width) {
							var d = f(mA(NA.imageWidth, NA.imageHeight), 2), w = d[0], E = d[1];
							l = (IA.current.width - w) / 2, c = (IA.current.height - DA - E) / 2, g = NA.width + w, u = NA.height + E, s = M = 1;
						} else {
							var B = NA.scaleX > 0 ? 1 : -1, I = NA.scaleY > 0 ? 1 : -1;
							s = NA.scaleX + i * n * B, M = NA.scaleY + i * n * I, void 0 !== A.maxScale && (Math.abs(s) > A.maxScale && (s = A.maxScale * B), Math.abs(M) > A.maxScale && (M = A.maxScale * I)), Math.abs(s) < EA && (s = EA * B), Math.abs(M) < EA && (M = EA * I), c = NA.top + -n * a / NA.scaleX * i * B, l = NA.left + -n * r / NA.scaleY * i * I, g = NA.width, u = NA.height;
						}
						QA(b(y, {
							width: g,
							scaleX: s,
					...
					n.useEffect((function() {
						return yA.current = !0, function() {
							yA.current = !1;
						};
					}), []), n.useEffect((function() {
						IA.current = BA();
					}), [A.container]), n.useEffect((function() {
						i && yA.current && QA(b(D, { visible: !0 }));
						...
						if (i) {
							if (!A.container) {
								...
								if (document.body.style.overflow = "hidden", document.body.scrollHeight > document.body.clientHeight && t > 0) {
									var n = parseFloat(window.getComputedStyle(document.body).paddingRight) || 0;
									document.body.style.paddingRight = "".concat(n + t, "px");
								}
								return function() {
									document.body.style.overflow = e.overflow, document.body.style.overflowX = e.overflowX, document.body.style.overflowY = e.overflowY, document.body.style.paddingRight = e.paddingRight;
								};
							}
						} else QA(b(h, {}));
					}), [i, A.container]), n.useEffect((function() {
						i && QA(b(v, { index: Q }));
					}), [
						Q,
						i,
						...
						NA.startLoading && (hA.current = NA.activeIndex, TA(NA.activeIndex));
					}), [NA.startLoading, NA.activeIndex]);
					var OA = "react-viewer", RA = c()("".concat(OA), "".concat(OA, "-transition"), (E(e = {}, "".concat(OA, "-inline"), A.container), E(e, A.className, A.className), e)), UA = {
						opacity: i && NA.visible ? 1 : 0,
						display: i || NA.visible ? "block" : "none"
					}, SA = {
						src: "",
						alt: ""
					};
					return i && NA.visible && !NA.loading && null !== NA.activeIndex && !NA.startLoading && (SA = xA()), n.createElement("div", {
						className: RA,
						style: UA,
						...
						className: "".concat(OA, "-mask"),
						style: { zIndex: m }
					}), A.noClose || n.createElement("div", {
						className: "".concat(OA, "-close ").concat(OA, "-btn"),
						onClick: function() {
							a();
						},
						style: { zIndex: m + 10 }
					}, n.createElement(s, { type: r.close })), n.createElement(g, {
						prefixCls: OA,
						imgSrc: NA.loadFailed && A.defaultImg.src || SA.src,
						visible: i,
						width: NA.width,
						height: NA.height,
						top: NA.top,
						...
						onResize: function() {
							if (IA.current = BA(), i) QA(b(y, {
								left: (IA.current.width - NA.width) / 2,
								top: (IA.current.height - NA.height - DA) / 2
							}));
						},
						zIndex: m + 5,
						scaleX: NA.scaleX,
					...
					}), A.noFooter || n.createElement("div", {
						className: "".concat(OA, "-footer"),
						style: { zIndex: m + 5 }
					}, gA || n.createElement(w, {
						prefixCls: OA,
						onAction: function(A) {
							if (jA(A.actionType), A.onClick) {
								var e = xA();
								A.onClick(e);
							}
						},
						...
						noImgDetails: cA,
						toolbars: J(M),
						activeIndex: NA.activeIndex,
						count: d.length,
						showTotal: sA,
						totalName: dA
					}), A.noNavbar || n.createElement(u, {
						prefixCls: OA,
						images: A.images,
						activeIndex: NA.activeIndex,
						onChangeImg: pA
				...
				e.default = function(A) {
					var e = n.useRef("undefined" != typeof document ? document.createElement("div") : null), t = Q(n.useState(A.container), 2), o = t[0], r = t[1], a = Q(n.useState(!1), 2), c = a[0], l = a[1];
					return n.useEffect((function() {
						document.body.appendChild(e.current);
					}), []), n.useEffect((function() {
						A.visible && !c && l(!0);
					}), [A.visible, c]), n.useEffect((function() {
						A.container ? r(A.container) : r(e.current);
					}), [A.container]), c ? i.createPortal(n.createElement(N, A), o) : null;
				};
			}
		]).default;
	}));
